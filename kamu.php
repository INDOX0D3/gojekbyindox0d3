...
echo color("blue","__________GOJEK AUTOCLAIM BY INDOX0D3 V1.0__________ \n");
echo color("blue","[+]  Time  : ".date('[d-m-Y] [H:i:s]')."   \n");
echo color("blue","[+]  Recode  By: YT INDOX0D3\n");
echo color("blue","[+]  Masukin OTP pake 62xxxxxxxxx ya sob \n");
